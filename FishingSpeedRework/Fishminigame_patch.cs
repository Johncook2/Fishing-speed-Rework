	...
	public static class FishMinigame_Update_Patch
	{
    	...
    	static void Update(FishMinigame __instance)
		{
			if (__instance.isGameRunning) {
				__instance.indicatorAngle += -__instance.difficultyConfig.rotationSpeed * Time.deltaTime * GameManager.Instance.PlayerStats.MinigameFishingSpeedModifier + __instance.difficultyConfig.rotationSpeed * Time.deltaTime;
			}
		}
	}
}
